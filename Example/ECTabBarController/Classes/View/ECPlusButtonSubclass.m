...
#import "ECPlusButtonSubclass.h"
#import "ECTabBarController.h"
#import "ECMineViewController.h"

@interface ECPlusButtonSubclass ()<UIActionSheetDelegate> {
    CGFloat _buttonImageHeight;
}

@end

@implementation ECPlusButtonSubclass
...
#pragma mark -
#pragma mark - ECPlusButtonSubclassing Methods
 ...
 */
+ (id)plusButton {
    ECPlusButtonSubclass *button = [[ECPlusButtonSubclass alloc] init];
...
//
//    ECPlusButtonSubclass* button = [ECPlusButtonSubclass buttonWithType:UIButtonTypeCustom];
//
...
#pragma mark - ECPlusButtonSubclassing
